...
from constants import BACKGROUND, GREEN, RED, FloatRect, Pair
...
class Game:
    ...
    def handle_events(self, events:list[pygame.event.Event]):
        ...
        for event in events:
            ...
            self.run_button.handle_event(event, self.camera)

    def update(self, dt:float):
        """Updates game logic"""
        self.run_button.update(self.camera)
    ...
    def draw(self, screen:pygame.SurfaceType):
        ...
        self.run_button.draw(screen, camera)
